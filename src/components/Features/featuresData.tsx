...
const featuresData: Feature[] = [
  {
    ...
    title: "IELTS, TOEFL IBT, Proficiency & SAT Exams",
    paragraph:
      "Prepare for your exams with targeted strategies, integrated video lessons on essential grammar and exam strategies, and personalized online lessons for Reading, Writing, Listening, and Speaking skills. We focus on building the skills and confidence you need to succeed.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Tailored Lessons for All Levels",
    paragraph:
      'We believe in "Your Journey, Your Pace". Whether you\'re just starting out or refining advanced skills, our courses are tailored to your level and goals. From foundational grammar to high-level test strategies, we guide you step-by-step, helping you improve at your own pace with expert instruction and support.',
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Our programs are designed for continuous improvement. With regular assessments and personalized feedback, you’ll stay on track to achieve your goals. Whether you’re preparing for IELTS, TOEFL IBT, SAT, or a Proficiency exam, we’ll help you reach your target score with expert-led, real-time guidance.",
  },
];
